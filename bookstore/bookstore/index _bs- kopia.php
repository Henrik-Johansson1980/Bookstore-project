...
//På index.php tänkte jag visa alla böcker i databasen när sidan laddas.
echo '<div id="showAll">';
//Nedan skapas en sql-fråga som väljer nödvändiga fält om
//samtliga böcker och relaterad info, som produktbilder författare och kategori..
//Jag använder en Concatfunktion och ALias för att slå ihop värden från två kolumner för att komma åt
//Författarens namn med ett anrop.
$sql = "SELECT
  b.*,
