<!-- Footer -->
<footer class="w3-padding-64 w3-dark-grey w3-small w3-center" id="footer">
  <div class="w3-row-padding">
    ...
    <div class="w3-col s4 w3-justify w3-mobile">
      <h4>Store</h4>
      <p><i class="fa fa-fw fa-map-marker"></i> LOGO-BOOKS</p>
...
<div class="w3-black w3-center w3-padding-24">
  <p>&copy; Henrik Johansson 2018</p>
